...
- If this extension has no locale available for your language, you could create it by following [these instructions](https://github.com/Odyseus/CinnamonTools/blob/master/BASICS.md#how-to-localize-extensions) and send the .po file to me.
