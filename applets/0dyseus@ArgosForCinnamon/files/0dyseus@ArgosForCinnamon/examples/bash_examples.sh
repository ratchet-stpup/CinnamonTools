...
echo "--Item with icon 12px symbolic | iconName=folder iconSize=12 iconIsSymbolic=true"
echo "--Item with icon 14px | iconName=folder iconSize=14"
echo "--Item with icon 16px symbolic | iconName=folder iconSize=16 iconIsSymbolic=true"
echo "--Item with icon 18px | iconName=folder iconSize=18"
echo "--Item with icon 20px symbolic | iconName=folder iconSize=20 iconIsSymbolic=true"
# Separator
echo "---"

echo "<b>ANSI colors, emojis and font size examples</b> | iconName=folder iconSize=24 size=12"
echo "--\033[34mANSI \033[32mcolors \033[31mexample \033[35m:smile:\033[0m | ansi=true size=20"
...
echo "--<span underline='single' underline_color='#FF0000'>Underline</span>\
